...
import GDriveIntegrity from "./GDriveIntegrity";
import DropboxIntegrity from "./DropboxIntegrity";
import OneDriveIntegrity from "./OneDriveIntegrity";
...
function Mylibrary() {
  ...
  useEffect(() => {
    const getBooks = async () => {
      let books = await Promise.all(
        user.personalisation.mylibrary.map(async (bookID) => {
          let res = await axios({
            method: "get",
            url: "http://api.gyanibooks.com/library/" + bookID + "/",
          });
          return res.data;
        })
      );
  ...
  const mylibraryClick = async (book) => {
    ...
    let res = await axios({
      method: "put",
      url:
        "http://api.gyanibooks.com/personalisation/" +
  ...
  return (
    ...
    >
      ...
      >
        <Items currentItems={mylibrarybooks}></Items>
      </div>
